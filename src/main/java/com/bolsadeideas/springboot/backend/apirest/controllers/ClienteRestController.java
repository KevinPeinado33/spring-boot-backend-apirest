...
public class ClienteRestController {
	...
	public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) { // tiene q llevar el
																									// @Valitd, por q si
																									// no, no se
																									// verificará
		...
		if (result.hasErrors()) { // para validar si trae errores
			 ...
			 * err.getDefaultMessage() + "' " + err.getDefaultMessage()); }
			 */

			List<String> errors = result.getFieldErrors().stream()// convertimos en un stream
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, BindingResult result, @PathVariable Long id) { // es
																														// importante
																														// el
																														// orden
																														// del
	...
	@GetMapping("/uploads/img/{nombreFoto:.+}") // :.+ expreción regular para indicar que viene con una extencion
